...
def main():
    ...
    if not csv_exists:
        ...
        print()
        print("To prepare the dataset:")
        print("  1. Open the delay predictor notebook:")
        print("     /Workspace/Users/mc240041016@iiti.ac.in/Drafts/delay predictor")
        print()
        print("  2. Run Cell 2 (Export Dataset for Streamlit)")
        print()
        print("  3. Copy the generated CSV to the data folder:")
        print("     cp /Workspace/Users/mc240041016@iiti.ac.in/Drafts/indian_railway_data.csv data/")
        print()
    ...
    api_client_exists = check_file_exists("api_client.py", "API Client (api_client.py)")
    ...
    if api_client_exists:
        ...
        with open("api_client.py", "r") as f:
            ...
            if 'GEMINI_API_KEY = "AIzaSy' in content:
                ...
                print("   Update line 13 in api_client.py with your Gemini API key")
    ...
    app_exists = check_file_exists("app.py", "Main application (app.py)")
